...
{
  while((UART_S1_REG(UART1_BASE_PTR)&UART_S1_TC_MASK) == 0){};
  UART_D_REG(UART1_BASE_PTR) = data;
}
...
void UpdateAPP()
{
	...
	{
		data_checked = 1; //  Correctframe with its own station number  received. 
	}
