...
__attribute__((section(".init")))const IdentType MCU_Identification = {BL_M0, "MKL26Z128#","1.0#" ,0x400, 0x40, 0x00020000, 0x001000, 0x0003FC, 0x0003FF};
		...
		{ 
			...
			switch(sci_buffer[4])
			{
				...
				case 'I':	// receive 'I' command, send  version information to UART    
							...
							sci_buffer[i++] = MCU_Identification.relocated_vectors.Bytes.hl;		//assign application start adddress
