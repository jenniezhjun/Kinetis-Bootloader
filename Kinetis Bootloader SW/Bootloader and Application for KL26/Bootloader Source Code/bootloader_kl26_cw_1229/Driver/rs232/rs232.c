...
void UART_Initialization(void)
{
	...
	{
		temp = (unsigned int)(BOOT_CORE_CLOCK / (16*BOOT_UART_BAUD_RATE));              // clock source is MCGFLLCLK by default
		
#ifdef USE_EXTERNAL_CLOCK
		 temp = (unsigned int)(BOOT_CORE_CLOCK / 2 / (16*BOOT_UART_BAUD_RATE));         // clock source is MCGPLLCLK/2
#endif
